...
# Lưu ý 
- Trước khi commit phải chỉnh sửa file này để người sau đọc.
- Chỉ merge vào main sau khi xong lab 5 (commit cuối). Lúc đó nhớ sửa readme lại thành phiên bản hoàn chỉnh (cho thầy đọc). Thầy sẽ xem repo này để chấm điểm!